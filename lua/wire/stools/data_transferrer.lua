...
WireToolSetup.open( "data_transferrer", "Transferrer", "gmod_wire_data_transferer", nil, "Transferrers" )
...
if ( CLIENT ) then
    ...
    language.Add( "Tool.wire_data_transferrer.0", "Primary: Create/Update data transferrer" )
